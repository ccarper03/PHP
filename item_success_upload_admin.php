...
$q2 = "INSERT INTO items (category_id, department_id, name, model, item_condition, description, price, date) 
		VALUES ('$category_id', '$department_id', '$item_name', '$model', '$condition', '$description', '$price', NOW() )";
$r2 = @mysqli_query ($dbc, $q2); // Run the query.

// get last inserted id from upload table
$item_id = mysqli_insert_id($dbc);

$q3 = "INSERT INTO pictures (item_id, upload_id, big_pic_1_name, big_pic_2_name, big_pic_3_name, big_pic_4_name,
		small_pic_1_name, small_pic_2_name, small_pic_3_name, small_pic_4_name, main_img_num)
		VALUES ('$item_id' , 'NULL', '$big_pic_1_name', '$big_pic_2_name', '$big_pic_3_name', '$big_pic_4_name',
				'$small_pic_1_name', '$small_pic_2_name',  '$small_pic_3_name',  '$small_pic_4_name', $main_img_num)";
...
if ($r3 && $r2) { // If it ran OK.
	...
	<h3>The new item was uploaded.</h3>';
	      echo "</div>";
	    echo "</div>";
	...
	echo '<p class="error">You could not add new item due to a system error. We apologize for any inconvenience.</p>';
	exit();
	}
